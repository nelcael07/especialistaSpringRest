...
import com.example.demo.api.assembler.RestauranteModelDiassembler;
...
public class RestauranteController {
	...
	public RestauranteModel adicionar(@RequestBody @Valid RestauranteInput restaurante) {
		try {
			Restaurante restauranteObject = restauranteDiassembler.toDomainObject(restaurante);
	...
	public RestauranteModel atualizar(@PathVariable Long id, @RequestBody @Valid RestauranteInput restauranteInput){
		try {
//			Restaurante restaurante = restauranteDiassembler.toDomainObject(restauranteInput);
			Restaurante restaurantebuscado = cadastroRestaurante.buscar(id);
			
			restauranteDiassembler.copyToDomainObject(restauranteInput, restaurantebuscado);
